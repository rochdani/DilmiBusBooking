...
public class CustomListview1 extends ArrayAdapter<String>{
    ...
    class ViewHolder{
        ...
        ViewHolder(View v){
            tvw1= v.findViewById(R.id.busno);
            tvw2= v.findViewById(R.id.noseat);
            tvw2= v.findViewById(R.id.type);
            tvw2= v.findViewById(R.id.from);
            tvw2= v.findViewById(R.id.destination);
            tvw2= v.findViewById(R.id.start);
            tvw2= v.findViewById(R.id.end);
            tvw2= v.findViewById(R.id.amount);
