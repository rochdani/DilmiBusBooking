...
//        Last_Name = (EditText)findViewById(R.id.editTextL_Name);
        ...
        nic= findViewById(R.id.editTextNo);
        phone= findViewById(R.id.editTextPh);
...
//        L_Name_Holder = Last_Name.getText().toString();
        ...
        CheckEditText = !TextUtils.isEmpty(F_Name_Holder) && !TextUtils.isEmpty(EmailHolder) && !TextUtils.isEmpty(PasswordHolder) && !TextUtils.isEmpty(NicHolder) && !TextUtils.isEmpty(PhoneHolder);
        CheckFlag = Email.getText().toString().trim().matches(emailPattern);
        CheckNic = nic.getText().toString().trim().matches(NICPattern);
    ...
    public void UserRegisterFunction(final String F_Name,  final String email, final String password, final String nic,final String phone){
        ...
        class UserRegisterFunctionClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(com.example.travels.HomeActivity.this, httpResponseMsg, Toast.LENGTH_LONG).show();
